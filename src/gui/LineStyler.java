...
class LineStyler implements LineStyleListener {
	...
	void initializeColors() {
		...
		colors = new Color[] { new Color(display, new RGB(0, 0, 0)), // black
				...
				new Color(display, new RGB(0, 139, 139)), // reserved keyword
				new Color(display, new RGB(25, 25, 112)), // id
				new Color(display, new RGB(46, 139, 87)) // comment
		};
